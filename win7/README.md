...
运行 `dist/FreeIsland-Win7-Setup-1.0.1.exe`，选择开机静默启动、桌面快捷方式后点击「安装浮岛」。安装完成后点击「打开浮岛」，或从开始菜单打开「浮岛 Win7」。无需管理员权限。
...
```powershell
.\dist\FreeIsland-Win7-Setup-1.0.1.exe --verify-payload "D:\free island\artifacts\win7-payload-check"
```
