...
$setupExecutable = Join-Path $outputDirectory 'FreeIsland-Win7-Setup-1.0.10.exe'
$zipPath = Join-Path $outputDirectory 'FreeIsland-Win7-Portable-1.0.10.zip'
...
BEGIN
 ...
 BEGIN
  ...
  BEGIN
   ...
   VALUE "OriginalFilename", "FreeIsland-Win7-Setup-1.0.10.exe\0"
